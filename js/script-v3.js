...
// ============================================================
const lightSurfaceLogoFiles = [
  "ai-workflow-automation-icon.svg",
  "ai-agents-icon.svg",
  "prompt-engineering-icon.svg",
  "process-mapping-icon.svg",
  "openai-logo.svg",
  "openrouter-logo.svg",
  "n8n-logo.svg",
  "notion-logo.svg",
...
function usesLightLogoSurface(imagePath = "") {
  return lightSurfaceLogoFiles.some((filename) => imagePath.endsWith(filename));
}
    ...
    <div class="tools-marquee-group" role="list"${hidden ? ' aria-hidden="true"' : ""}>
      ${items
        ...
        <div class="tool-logo-card" role="listitem" title="${tool.name}">
          <span class="tool-logo-image-wrap${usesLightLogoSurface(tool.image) ? " tool-logo-image-wrap--light" : ""}">
            <img
